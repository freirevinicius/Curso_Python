...
if (peso > limite):
    excesso = excesso - peso
    total_descontado = excesso * multa
    print("O EXCESSO DE PESO FOI:", (abs(round(excesso))))
    print("PORTANTO A MULTA É DE R$", abs(round(total_descontado, 2)))
else:
    print("A QUANTIDADE DE {}KG ESTÁ DENTRO DO LIMITE DE 50.0KG, PORTANTO NÃO TERÁ MULTA.
    ".format(peso))
